        ...
        <div class="card-body">
            <form method="GET" class="summary_search" action="{{ route($routePrefix . '.index') }}">
                <div class="row mb-4">
                    ...
                    <div class="col-md-3">
                        <x-Inputs.drop-down name="is_active" label="Active" :value="$search['is_active']" :list="$yes_no_list"
                            class="form-control select2" />
                    </div>
                    <div class="col-md-3">
                        <x-Inputs.drop-down name="product_type" label="Item Type" :value="$search['product_type'] ?? null" :list="[
                            0 => 'Spare',
                            1 => 'Finished',
                            2 => 'Part',
                        ]"
