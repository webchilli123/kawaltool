    ...
    var customcard = {
      init: function () {
        $(".card-header-right .close-card").on("click", function () {
          ...
          $(".card-header-right .card-option .fa-solid.fa-ellipsis").on(
            "click",
            function () {
              var $this = $(this);
              if ($this.hasClass("fa-angles-right")) {
                $(this).addClass("fa-ellipsis");
                $this.parents(".card-option").animate({
                  width: "35px",
                });
              } else {
                $(this).removeClass("fa-ellipsis");
                $this.parents(".card-option").animate({
                  width: "230px",
                });
              }
              $(this).toggleClass("fa-angles-right").fadeIn("slow");
            }
          ),
