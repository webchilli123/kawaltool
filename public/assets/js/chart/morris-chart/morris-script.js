  ...
  var morris_chart = {
    init: function () {
      Morris.Area({
        ...
        ykeys: ["y", "z"],
        labels: ["Y", "Z"],
        lineColors: [AdmiroAdminConfig.secondary, AdmiroAdminConfig.primary],
      }),
        Morris.Line({
          ...
          xkey: "y",
          ykeys: ["a", "b"],
          lineColors: [AdmiroAdminConfig.primary, AdmiroAdminConfig.secondary],
        ...
        Morris.Bar({
          ...
          ykeys: ["y"],
          labels: ["Y"],
          barColors: [AdmiroAdminConfig.primary],
        }),
        $(function () {
          var b = [
            {
          ...
          Morris.Bar({
            ...
            data: b,
            barColors: [AdmiroAdminConfig.primary, AdmiroAdminConfig.secondary],
            xkey: "period",
        ...
        $(function () {
          ...
          window.m = Morris.Line({
            ...
            labels: ["sin(x)"],
            parseTime: !1,
            lineColors: [AdmiroAdminConfig.primary],
